...
public class myadapterMandalOverView extends RecyclerView.Adapter<myadapterMandalOverView.myviewholder>
{
    ...
    @NonNull
    @Override
    public myadapterMandalOverView.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow_overview,parent,false);
        return new myadapterMandalOverView.myviewholder(view);
    }
