...
public class Demo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, constituency, Toast.LENGTH_SHORT).show();
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                        ...
                                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                            ...
                                            for (DocumentSnapshot d : list) {
                                                ...
                                                if(obj1.getConstituency().equalsIgnoreCase(constituency)){
    ...
    public void unitReport(View view) {
        ...
        String Fnamexls=constituency+" Unit_wise_report"+System.currentTimeMillis()+ ".xls";
