...
public class CollectorUserDetailsAmountToDB2 extends AppCompatActivity {
                    ...
                    db.collection("individuals")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toast.makeText(CollectorUserDetailsAmountToDB2.this, "Status Approval: "+approved, Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(CollectorUserDetailsAmountToDB2.this, CollectorAmountToDB2.class);
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(CollectorUserDetailsAmountToDB2.this, "Error occured", Toast.LENGTH_SHORT).show();
                        }
                    });

                }else{

                    Toast.makeText(CollectorUserDetailsAmountToDB2.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
