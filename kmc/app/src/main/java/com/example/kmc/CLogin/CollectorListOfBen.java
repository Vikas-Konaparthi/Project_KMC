...
public class CollectorListOfBen extends AppCompatActivity implements com.example.kmc.List{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new myadapter4(datalist,village,CollectorListOfBen.this,CollectorListOfBen.this);
                    ...
                    db.collection("individuals")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toast.makeText(CollectorListOfBen.this, "Status Approval: "+approved, Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(CollectorListOfBen.this, CollectorListOfBen.class);
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(CollectorListOfBen.this, "Error occured", Toast.LENGTH_SHORT).show();
                        }
                    });

                }else{
                    Toast.makeText(CollectorListOfBen.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
