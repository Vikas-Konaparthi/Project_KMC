...
public class CollectorUserDetails2 extends AppCompatActivity {
                ...
                .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    db.collection("individuals")
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(CollectorUserDetails2.this, "Error occured", Toast.LENGTH_SHORT).show();
                        }
                    });

                }else{
                    Toast.makeText(CollectorUserDetails2.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
