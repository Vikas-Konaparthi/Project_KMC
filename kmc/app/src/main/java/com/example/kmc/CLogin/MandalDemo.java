...
public class MandalDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, mandal, Toast.LENGTH_SHORT).show();
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                        ...
                                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                            ...
                                            for (DocumentSnapshot d : list) {
                                                ...
                                                if(obj1.getMandal().equalsIgnoreCase(mandal)){
    ...
    public void unitReport(View view) {
        ...
        String Fnamexls=mandal+" Unit_wise_report"+System.currentTimeMillis()+ ".xls";
