...
public class CollectorUserDetailsAmountDBToBen2 extends AppCompatActivity {
                ...
                if(task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    db.collection("individuals")
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(CollectorUserDetailsAmountDBToBen2.this, "Error occured", Toast.LENGTH_SHORT).show();
                        }
                    });

                }else{

                    Toast.makeText(CollectorUserDetailsAmountDBToBen2.this, "Failed", Toast.LENGTH_SHORT).show();
