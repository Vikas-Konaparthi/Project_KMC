...
public class SelectionElements4 {
    String aadhar;
    String dbAccount;
    ...
    public SelectionElements4(String aadhar, String dbAccount, String approvalAmount, String soApprovalAmount, String status, String benAccountAmount) {
        this.aadhar = aadhar;
